...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // team_1.
        //scores.insert(team_1_name,Team { goals_scored: team_1_score.clone(),goals_conceded: team_2_score.clone()});
        //scores.insert(team_2_name,Team { goals_scored: team_2_score.clone(),goals_conceded: team_1_score.clone()});
